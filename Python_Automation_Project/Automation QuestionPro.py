"""
    ...
    Automate collection of judges' score for each contestant from QuestionPro exported as a CSV file. Calculate and present results in Excel dashboard. Present a report that contains the results, rankings, alerts, and duplicate submissions.
"""
...
# Add Select File button with click function
...
# Add Calculate button with click function
